...
def main():
    ...
    parser.add_argument('--logdir', default='log/ddpg' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    # train
    parser.add_argument('--warmup', default=10000, type=int) # 10000
    parser.add_argument('--episode', default=1200, type=int) # 1200
    parser.add_argument('--batch_size', default=64, type=int)
    parser.add_argument('--capacity', default=500000, type=int)
    parser.add_argument('--lra', default=1e-3, type=float) # 1e-3
    parser.add_argument('--lrc', default=1e-3, type=float) # 1e-3
    ...
    parser.add_argument('--seed', default=802, type=int)
